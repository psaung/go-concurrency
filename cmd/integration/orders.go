...
const ordersEndpoint string = "http://localhost:8000/orders"
const productsEndpoint string = "http://localhost:8000/products"
const indexEndpoint string = "http://localhost:8000/"
